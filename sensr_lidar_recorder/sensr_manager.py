...
class SensrManager:
    ...
    def __init__(self, host="112.133.37.122", port=9080):
        self.host = host
        self.port = port
    ...
    def delete_sensor(self, sensor_id: str) -> bool:
        ...
        try:
            response = requests.delete(sensor_url, timeout=10)
    ...
    def create_project(self, name: str, path: Optional[str] = None) -> bool:
        ...
        try:
            response = requests.put(project_url, timeout=30)
    ...
    def load_project(self, name: str, path: Optional[str] = None) -> bool:
        ...
        try:
            response = requests.post(project_url, timeout=30)
